...
| 16 | `16_update_round2_pricing_and_abstract_deadline.sql` | Corrective state ปัจจุบัน: ขยาย Early Bird ถึงสิ้นงาน 30 ต.ค., Regular ฿2,500, ปิด Late, ขยาย Abstract ถึง 20 ก.ย. |
...
- Early Bird General = ฿1,250 และแถว ticket ถูกเปิดถึงเวลาจบงาน 30 ตุลาคม 2569 เวลา 17:30 น. (Bangkok). สิทธิ์ขยายราคาจริงยังถูกบังคับแบบราย user ใน `conference-api`.
